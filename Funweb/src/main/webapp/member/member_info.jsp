...
<%
// MemberDAO 객체의 selectMemberInfo 메소드를 호출하여 회원 상세정보 조회 후 폼에 출력하기
		...
		<article>
			...
			<form action="member_update.jsp" method="post" id="join" name="fr">
				<fieldset>
					...
					<label>User Id</label> 
					<input type="text" name="id" class="id" id="id" value="<%=id %>" readonly required><br>
					...
					<label>Name</label> 
					<input type="text" name="name" id="name" value="<%=member.getName() %>" required><br> 
					
					<label>E-Mail</label> 
					<input type="email" name="email" id="email" value="<%=member.getEmail() %>" required><br> 
				</fieldset>
