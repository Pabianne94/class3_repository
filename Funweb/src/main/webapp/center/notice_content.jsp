...
// BoardDAO 객체의 updateReadcount 메소드를 호출하여 게시물 조회수 증가
// >> 파라미터 : 글번호(num), 리턴타입 : void
dao.updateReadcount(num);


// BoardDAO 객체의 selectBoard 메소드를 호출하여 게시물 상세 내용 조회
